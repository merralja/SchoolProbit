...
YOu know, this looks pretty random, so later I'm going to want to do some area analysis on this later. Maybe I need to split deltaincome into more quantiles.
...
So basically, right now it looks like the only significant variable is whether income later grew faster than average: Areas that saw less income growth were ones where the primary school distance increased.
