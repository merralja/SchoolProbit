#' publicschools2016secondary: a 2015-2016 secondary schools sf point file for Hamilton, Ontario.
#'
#' This dataset contains an sf points file in NAD83 UTM Zone 17N, for each secondary school
#' in the Hamilton public board.
#'
#' @format Simple feature collection with 13 features and 8 fields:
#' \describe{
