...
#
# load the DA geometry file, join it to census file
#
...
```{r print-DA-map, echo = FALSE, fig.cap="\\label{fig:DA-map} map of DAs with school closures"}}
...
```{r}
# Change line color by school closed
...
a + geom_density(aes(color = as.factor(Isschoolclosed))) +
  ...
  labs(title="Income characterists of closed and non-closed DAs",x="DA 2006 average after-tax household income", y = "Density")
```
